      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-dark via-primary-teal to-primary-dark flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <Link
              to="/auth/login"
              className="inline-block bg-accent-orange hover:bg-accent-red transition-colors duration-300 text-white px-6 py-3 rounded-lg font-semibold"
            >
              Back to Login
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-dark via-primary-teal to-primary-dark flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-white/80">Join us for an amazing dining experience</p>
        </div>
